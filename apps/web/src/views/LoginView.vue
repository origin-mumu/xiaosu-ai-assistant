...
<template>
  <main class="login-page">
    <section class="login-showcase">
      <div class="login-brand"><img src="/xiaosu-mascot.png" alt="小苏" /><span>小苏企业智能助手</span></div>
      <div class="login-hero">
        <div class="mascot-stage"><img src="/xiaosu-mascot.png" alt="小苏助手形象" /></div>
        <span class="login-kicker">XIAOSU AI CONSOLE</span>
        <h1>让企业知识，<br />随问随答。</h1>
        <p>统一管理知识库、员工问答、钉钉接入与模型运行状态。</p>
      </div>
      <div class="login-feature-row"><span>知识库问答</span><span>工具调用</span><span>钉钉 Stream</span></div>
    </section>
    ...
    <section class="login-panel-wrap">
      <div class="login-panel">
        ...
        <el-form class="login-form" @submit.prevent="submit">
          ...
          <label>登录密码</label>
          <el-input v-model="password" size="large" type="password" show-password autocomplete="current-password" placeholder="请输入密码" @keydown.enter="submit">
        ...
        <div class="login-security"><span></span>会话凭证仅保存在 HttpOnly Cookie 中</div>
      </div>
